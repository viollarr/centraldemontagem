  ...
  <tr>
	...
	<table width="570" border="0" align="center" cellpadding="2" cellspacing="1" class="texto cor_tr">
	  ...
	  <tr>
            ...
            <td colspan="2">
            	<input type="text" size="15" maxlength="10" tabindex="1" name="data_recebimento" id="data_recebimento" onKeyUp="barra(this)" />
             </td>
      ...
      <tr>
        ...
        <td width="227"><input type="text" size="15" maxlength="10" name="data_faturamento" id="data_faturamento" tabindex="5" onkeyup="barra(this)" /></td>
      ...
      <tr>
        ...
        <td align="left" colspan="3"><input type="text" name="res" id="res" size="13" maxlength="9" onKeyUp="telefone(this)" tabindex="16" />

        <script language="javascript">addCampos('res');</script>

        &nbsp;&nbsp;Telefone2:&nbsp;<input type="text" name="res2" id="res2" size="13" maxlength="9" onKeyUp="telefone(this)" tabindex="17" />

        <script language="javascript">addCampos('res2');</script>

        &nbsp;&nbsp;Telefone3:&nbsp;<input type="text" name="res3" id="res3" size="13" maxlength="9" onKeyUp="telefone(this)" tabindex="18" /></td>
