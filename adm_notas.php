  ...
  <tr>
    ...
    <td width="578" valign="top">
        ...
        <td align="left">
        	...
        	<?php
			 ...
			 if( strstr($_SERVER['HTTP_USER_AGENT'], $ie8)){
			   ...
			   echo '<form action="adm_notas.php?buscar=buscar" method="get" enctype="application/x-www-form-urlencoded">';

			 }elseif (( strstr($_SERVER['HTTP_USER_AGENT'], $ie7)) or ( strstr($_SERVER['HTTP_USER_AGENT'], $ie6))) {

			   echo '<form action="adm_notas.php?buscar=buscar" method="get" enctype="application/x-www-form-urlencoded" style="margin:0 0 0 7px;">';
      ...
      <tr>
        ...
        <td><?php include "php/inc_adm_notas.php"; ?></td>
