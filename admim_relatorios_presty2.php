...
<table width="778" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<form action="adm_relatorios_presty2.php" method="post" enctype="multipart/form-data" name="frm" id="frm">
	...
	<table width="570" border="0" align="center">
      ...
      <tr>
        ...
        <td><ul><li>Selecione a prioridade, o tipo de conclus&atilde;o e as data de inicio e data final para gerar o relat&oacute;rio:</li></ul></td>
