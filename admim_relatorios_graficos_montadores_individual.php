...
<table width="778" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<form action="php/inc_adm_relatorios_graficos_montadores_individual.php" method="post" enctype="multipart/form-data" name="frm" id="frm" target="_blank">
	...
	<table width="570" border="0" align="center">
      ...
      <tr><td>&nbsp;</td></tr>
      <tr>
        <td><ul><li>Selecione as data de inicio e data final para gerar o gráfico:</li></ul></td>
      </tr>
      <tr><td>&nbsp;</td></tr>
	  <tr>
