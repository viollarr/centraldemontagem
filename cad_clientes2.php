...
function buscaEndereco(cep, uf) {
	$.getJSON('php/busca_endereco2.php',{cep: cep, uf: uf, ajax: 'true'}, function(j){
		//alert("teste");
	...
	<table width="570" border="0" align="center" cellpadding="2" cellspacing="1" class="texto cor_tr">
     ...
     <tr>
       ...
       <td align="left" colspan="3">
     		<select name="bairro" id="bairro" tabindex="13">
       ...
       &nbsp;&nbsp;Estado:&nbsp;<select name="estado" id="estado" tabindex="14">
                        ...
                        <?php
                            foreach($estados AS $estado){
                                echo '<option desc="'.htmlentities($estado['nome']).'" uf="'.$estado['sigla'].'" value="'.$estado['cod_estados'].'">'.$estado['sigla'].'</option>';
                            }
                        ?>
                    </select> </td>
