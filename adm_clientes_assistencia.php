  ...
  <tr>
    ...
    <td width="578" valign="top">
        ...
        <td align="left">
        	...
        	<?php
			 ...
			 if( strstr($_SERVER['HTTP_USER_AGENT'], $ie8)){
			   ...
			   echo '<form action="adm_clientes_assistencia.php?buscar=buscar&tipo=tipo" method="get" enctype="application/x-www-form-urlencoded">';

			 }elseif (( strstr($_SERVER['HTTP_USER_AGENT'], $ie7)) or ( strstr($_SERVER['HTTP_USER_AGENT'], $ie6))) {

			   echo '<form action="adm_clientes_assistencia.php?buscar=buscar&tipo=tipo" method="get" enctype="application/x-www-form-urlencoded" style="margin:0 0 0 7px;">';
      ...
      <tr>
        ...
        <td><?php include "php/inc_adm_clientes_assistencia.php"; ?></td>
      ...
      <td bgcolor="#FF0000"></td>
        ...
        <td align="left">
            ...
            <img src='images/ampulheta.gif' border='0' align="absbottom" /> = Em Atendimento |<br />

            <img src='images/ico_excluir.jpg' border='0' /> = N&Atilde;O Executado | 
