...
<table width="778" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<form action="php/inc_adm_relatorios_graficos_montadores.php" method="post" enctype="multipart/form-data" name="frm" id="frm" target="_blank">
	<table width="570" border="0" align="center">
      ...
      <tr><td>&nbsp;</td></tr>
      <tr>
        <td><ul><li>Selecione o montador e as data de inicio e data final para gerar o gr&aacute;fico:</li></ul></td>
      </tr>
      <tr><td>&nbsp;</td></tr>
      <tr>
        ...
        <table>
          ...
          <td>Montador:</td>
            <td>
              ...
              <?php
                $select_all = "SELECT * FROM montadores WHERE ativo_m = '1' AND id_empresa = '1' ORDER BY nome ASC";
