...
if(!empty($_GET['n_montagem'])){
	$n_montagem = $_GET['n_montagem'];
}
else{
	$n_montagem = '';
}
	...
	<script type="text/javascript" src="js/funcoes.js"></script>
   	<script language="javascript">	
			$(document).ready(function(){
				var n_montagem = '<?php echo $n_montagem?>';
				if(n_montagem.length > 0){
					$("#vlm").val(n_montagem);
					$("#botao").trigger("click");
				}
			});
  ...
  <tr>
	...
	<table width="570" border="0" align="center">
	  ...
	  <tr>
        ...
        </select>&nbsp;&nbsp;&nbsp;&nbsp;<input id="botao" name="OK" type="submit"  value="OK"/></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
