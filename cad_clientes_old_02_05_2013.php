				...
				$.getJSON(//esse método do jQuery, só envia GET
						...
						//alert(data);//apenas para debugar a variável
								...
								$.each(data, function(i, obj){
										...
										$( option[i] ).attr( {value : obj.id, selected : ( IdSelCidade == removeAcentos(obj.nome) ) ? true : false } );//colocando o value no option
       ...
       <td align="left" colspan="3"><select name="bairro" id="bairro" tabindex="13">
                        ...
                        <?php
                            foreach($bairros AS $bairro){
                                echo "<option value='".$bairro['nome']."'>".htmlentities($bairro['nome'])."</option>";
                            }
                        ?>
