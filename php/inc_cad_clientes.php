...
$vendedor				= utf8_decode(trim($_POST['vendedor']));
...
$nome_cliente			= utf8_decode(trim($_POST['nome_cliente']));

$cep					= trim($_POST['cep']);

$rua					= strtoupper(strtr(strtoupper(utf8_decode(strtoupper(trim($_POST['rua'])))) ,"áéíóúâêôãõàèìòùç","ÁÉÍÓÚÂÊÔÃÕÀÈÌÒÙÇ"));

$numero					= trim($_POST['numero']);

$comp					= trim($_POST['comp']);

$bairro					= strtoupper(strtr(strtoupper(utf8_decode(strtoupper(trim($_POST['bairro'])))) ,"áéíóúâêôãõàèìòùç","ÁÉÍÓÚÂÊÔÃÕÀÈÌÒÙÇ"));
...
$referencia_cliente		= utf8_decode(trim($_POST['referencia_cliente']));
...
$select = "SELECT * FROM clientes WHERE ((n_montagem = '$n_montagem' AND nome_cliente = '$nome_cliente') OR (orcamento = '$orcamento' AND cod_loja = '$cod_loja' AND cod_cliente = '$cod_cliente') OR (orcamento = '$orcamento' AND nome_cliente = '$nome_cliente' AND n_montagem = '$n_montagem') OR (n_montagem = '$n_montagem')) ";
//$select = "SELECT * FROM clientes WHERE ((n_montagem = '$n_montagem' AND nome_cliente = '$nome_cliente') OR (orcamento = '$orcamento' AND nome_cliente = '$nome_cliente' AND n_montagem = '$n_montagem') OR (n_montagem = '$n_montagem')) ";
