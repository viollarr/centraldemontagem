...
if ((strlen($mont)>0)&&($data_inicio!='--')&&($data_fim!='--')){
		...
		echo "<table border='0' width='900' cellspacing='1' bgcolor='#000000'>
				...
				<tr>
				  ...
				  <td align='center' width='100' bgcolor='#F2F2F2' style='font-family:Arial;'><b>Descri&ccedil;&atilde;o</b></td>
			...
			if($not == 2){
				...
				echo "<td align='center' width='100' bgcolor='#F2F2F2' style='font-family:Arial;'><b>Visto Montador</b></td>
				  ...
				  <td align='center' width='100' bgcolor='#F2F2F2' style='font-family:Arial;'><b>Visto Gerência</b></td>
	...
	if($rs["porcentagem"] == 1){		
			...
			if($prioridade == 0){
				...
				if($tipo == 3){
					...
					$preco_montador = number_format(($rs['preco_montador']+(($rs['preco_montador']*$porcentagem)/100)),2,',','');

					$preco_montador2 = number_format(($p['preco_montador']+(($p['preco_montador']*$porcentagem)/100)),2,',','');

					$preco_montador3 = number_format(($q['preco_montador']+(($q['preco_montador']*$porcentagem)/100)),2,',','');

					$preco_montador4 = number_format(($r['preco_montador']+(($r['preco_montador']*$porcentagem)/100)),2,',','');

					$preco_montador5 = number_format(($s['preco_montador']+(($s['preco_montador']*$porcentagem)/100)),2,',','');

					$preco_montador6 = number_format(($t['preco_montador']+(($t['preco_montador']*$porcentagem)/100)),2,',','');

					$preco_montador7 = number_format(($u['preco_montador']+(($u['preco_montador']*$porcentagem)/100)),2,',','');

					$preco_montador8 = number_format(($v['preco_montador']+(($v['preco_montador']*$porcentagem)/100)),2,',','');

					$preco_montador9 = number_format(($x['preco_montador']+(($x['preco_montador']*$porcentagem)/100)),2,',','');

					$preco_montador10 = number_format(($z['preco_montador']+(($z['preco_montador']*$porcentagem)/100)),2,',','');

					$preco_montador11 = number_format(($a['preco_montador']+(($a['preco_montador']*$porcentagem)/100)),2,',','');

					$preco_montador12 = number_format(($b['preco_montador']+(($b['preco_montador']*$porcentagem)/100)),2,',','');

					$preco_montador13 = number_format(($c['preco_montador']+(($c['preco_montador']*$porcentagem)/100)),2,',','');

					$preco_montador14 = number_format(($d['preco_montador']+(($d['preco_montador']*$porcentagem)/100)),2,',','');

					$preco_montador15 = number_format(($e['preco_montador']+(($e['preco_montador']*$porcentagem)/100)),2,',','');

					$preco_montador16 = number_format(($f['preco_montador']+(($f['preco_montador']*$porcentagem)/100)),2,',','');

					$preco_montador17 = number_format(($g['preco_montador']+(($g['preco_montador']*$porcentagem)/100)),2,',','');

					$preco_montador18 = number_format(($h['preco_montador']+(($h['preco_montador']*$porcentagem)/100)),2,',','');

					$preco_montador19 = number_format(($i['preco_montador']+(($i['preco_montador']*$porcentagem)/100)),2,',','');

					$preco_montador20 = number_format(($j['preco_montador']+(($j['preco_montador']*$porcentagem)/100)),2,',','');	
				...
				elseif($tipo == 7){
					...
					$preco_montador = number_format((7.50+((7.50*$porcentagem)/100)),2,',','');

					$preco_montador2 = number_format((7.50+((7.50*$porcentagem)/100)),2,',','');

					$preco_montador3 = number_format((7.50+((7.50*$porcentagem)/100)),2,',','');

					$preco_montador4 = number_format((7.50+((7.50*$porcentagem)/100)),2,',','');

					$preco_montador5 = number_format((7.50+((7.50*$porcentagem)/100)),2,',','');

					$preco_montador6 = number_format((7.50+((7.50*$porcentagem)/100)),2,',','');

					$preco_montador7 = number_format((7.50+((7.50*$porcentagem)/100)),2,',','');

					$preco_montador8 = number_format((7.50+((7.50*$porcentagem)/100)),2,',','');

					$preco_montador9 = number_format((7.50+((7.50*$porcentagem)/100)),2,',','');

					$preco_montador10 = number_format((7.50+((7.50*$porcentagem)/100)),2,',','');

					$preco_montador11 = number_format((7.50+((7.50*$porcentagem)/100)),2,',','');

					$preco_montador12 = number_format((7.50+((7.50*$porcentagem)/100)),2,',','');

					$preco_montador13 = number_format((7.50+((7.50*$porcentagem)/100)),2,',','');

					$preco_montador14 = number_format((7.50+((7.50*$porcentagem)/100)),2,',','');

					$preco_montador15 = number_format((7.50+((7.50*$porcentagem)/100)),2,',','');

					$preco_montador16 = number_format((7.50+((7.50*$porcentagem)/100)),2,',','');

					$preco_montador17 = number_format((7.50+((7.50*$porcentagem)/100)),2,',','');

					$preco_montador18 = number_format((7.50+((7.50*$porcentagem)/100)),2,',','');

					$preco_montador19 = number_format((7.50+((7.50*$porcentagem)/100)),2,',','');

					$preco_montador20 = number_format((7.50+((7.50*$porcentagem)/100)),2,',','');	

				}

				elseif($tipo == 8){

					$preco_montador = number_format((9.00+((9.00*$porcentagem)/100)),2,',','');

					$preco_montador2 = number_format((9.00+((9.00*$porcentagem)/100)),2,',','');

					$preco_montador3 = number_format((9.00+((9.00*$porcentagem)/100)),2,',','');

					$preco_montador4 = number_format((9.00+((9.00*$porcentagem)/100)),2,',','');

					$preco_montador5 = number_format((9.00+((9.00*$porcentagem)/100)),2,',','');

					$preco_montador6 = number_format((9.00+((9.00*$porcentagem)/100)),2,',','');

					$preco_montador7 = number_format((9.00+((9.00*$porcentagem)/100)),2,',','');

					$preco_montador8 = number_format((9.00+((9.00*$porcentagem)/100)),2,',','');

					$preco_montador9 = number_format((9.00+((9.00*$porcentagem)/100)),2,',','');

					$preco_montador10 = number_format((9.00+((9.00*$porcentagem)/100)),2,',','');

					$preco_montador11 = number_format((9.00+((9.00*$porcentagem)/100)),2,',','');

					$preco_montador12 = number_format((9.00+((9.00*$porcentagem)/100)),2,',','');

					$preco_montador13 = number_format((9.00+((9.00*$porcentagem)/100)),2,',','');

					$preco_montador14 = number_format((9.00+((9.00*$porcentagem)/100)),2,',','');

					$preco_montador15 = number_format((9.00+((9.00*$porcentagem)/100)),2,',','');

					$preco_montador16 = number_format((9.00+((9.00*$porcentagem)/100)),2,',','');

					$preco_montador17 = number_format((9.00+((9.00*$porcentagem)/100)),2,',','');

					$preco_montador18 = number_format((9.00+((9.00*$porcentagem)/100)),2,',','');

					$preco_montador19 = number_format((9.00+((9.00*$porcentagem)/100)),2,',','');

					$preco_montador20 = number_format((9.00+((9.00*$porcentagem)/100)),2,',','');	

				}

				elseif($tipo == 9){

					$preco_montador = number_format((($rs['preco_montador']+(($rs['preco_montador']*$porcentagem)/100))/2),2,',','');

					$preco_montador2 = number_format((($p['preco_montador']+(($p['preco_montador']*$porcentagem)/100))/2),2,',','');

					$preco_montador3 = number_format((($q['preco_montador']+(($q['preco_montador']*$porcentagem)/100))/2),2,',','');

					$preco_montador4 = number_format((($r['preco_montador']+(($r['preco_montador']*$porcentagem)/100))/2),2,',','');

					$preco_montador5 = number_format((($s['preco_montador']+(($s['preco_montador']*$porcentagem)/100))/2),2,',','');

					$preco_montador6 = number_format((($t['preco_montador']+(($t['preco_montador']*$porcentagem)/100))/2),2,',','');

					$preco_montador7 = number_format((($u['preco_montador']+(($u['preco_montador']*$porcentagem)/100))/2),2,',','');

					$preco_montador8 = number_format((($v['preco_montador']+(($v['preco_montador']*$porcentagem)/100))/2),2,',','');

					$preco_montador9 = number_format((($x['preco_montador']+(($x['preco_montador']*$porcentagem)/100))/2),2,',','');

					$preco_montador10 = number_format((($z['preco_montador']+(($z['preco_montador']*$porcentagem)/100))/2),2,',','');

					$preco_montador11 = number_format((($a['preco_montador']+(($a['preco_montador']*$porcentagem)/100))/2),2,',','');

					$preco_montador12 = number_format((($b['preco_montador']+(($b['preco_montador']*$porcentagem)/100))/2),2,',','');

					$preco_montador13 = number_format((($c['preco_montador']+(($c['preco_montador']*$porcentagem)/100))/2),2,',','');

					$preco_montador14 = number_format((($d['preco_montador']+(($d['preco_montador']*$porcentagem)/100))/2),2,',','');

					$preco_montador15 = number_format((($e['preco_montador']+(($e['preco_montador']*$porcentagem)/100))/2),2,',','');

					$preco_montador16 = number_format((($f['preco_montador']+(($f['preco_montador']*$porcentagem)/100))/2),2,',','');

					$preco_montador17 = number_format((($g['preco_montador']+(($g['preco_montador']*$porcentagem)/100))/2),2,',','');

					$preco_montador18 = number_format((($h['preco_montador']+(($h['preco_montador']*$porcentagem)/100))/2),2,',','');

					$preco_montador19 = number_format((($i['preco_montador']+(($i['preco_montador']*$porcentagem)/100))/2),2,',','');

					$preco_montador20 = number_format((($j['preco_montador']+(($j['preco_montador']*$porcentagem)/100))/2),2,',','');	
