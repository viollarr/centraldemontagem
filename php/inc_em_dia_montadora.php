...
include"config.php";
	...
	$select_query = "SELECT * FROM datas d, clientes c, ordem_montagem o WHERE d.n_montagens = c.n_montagem AND d.n_montagens = o.n_montagem AND o.id_montador ='0' AND d.data_limite >= '$data_hoje' AND d.data_final = '0000-00-00'";
	...
	$select_paginacao = "SELECT * FROM datas d, clientes c, ordem_montagem o WHERE d.n_montagens = c.n_montagem AND d.n_montagens = o.n_montagem AND o.id_montador ='0' AND d.data_limite >= '$data_hoje' AND d.data_final = '0000-00-00' ORDER BY data_limite ASC LIMIT $inicio, $lpp";
	$sql = mysql_query($select_paginacao); // Executa a query no MySQL com o limite de linhas.
		...
		echo "<thead>";
		echo "<tr>";
		echo "<td class=titulo colspan=6>:: Clientes no Prazo na Montadora ::</td>";
		echo "</tr>";
		echo "<tr>";
