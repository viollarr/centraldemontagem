...
if ($contagem == 1){
	...
	$cadastrar = mysql_query("INSERT INTO $TABLE_usuarios (inicio, ip, ip_inicio, data_hora, nome, login, senha, email, tipo) VALUES ('$inicio', '$ip', '$ip_inicio','$data_hora', '$nome', '$login',	'$senha', '$email', '$tipo')"); //insere os campos na tabela
