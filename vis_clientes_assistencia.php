...
<script language="javascript" type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("input[name=cod_cliente2]").click(function(){
		...
		$("input[name=cod_cliente3]").click(function(){
		...
		$("input[name=cod_cliente4]").click(function(){
		...
		$("input[name=cod_cliente5]").click(function(){
  ...
  <tr>
    ...
    <td width="578" valign="top">
      ...
      <tr>
        ...
        <td><?php include "php/inc_vis_clientes_assistencia.php"; ?></td>
